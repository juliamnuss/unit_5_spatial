---
title: "5.2: Points, lines and polygons"
format:
  html:
...
CAN_crit_hab_sf = CAN_crit_hab %>% 
  ...
  st_cast(to="POLYGON") # converts btwn spatial geometries
head(CAN_crit_hab_sf) # 2 simple features, with habitat and country attributes
```
